...
DermCare is your trusted destination for comprehensive skincare solutions, committed to enhancing your skin health and well-being. Our platform provides a wealth of information about various skin conditions, empowering you with knowledge to understand and manage your skin's unique needs. Whether you're looking to explore the intricacies of different skin diseases or seeking personalized advice, DermCare is here for you
        ...
        <div>
         ...
         <div>
<Link className="font-sans" to="index.html ">Home</Link>
         </div>
         <div>
             <Link className="font-sans" to="donate.html">Donate</Link>
            </div> 
            <div>
            <Link className="font-sans" to="about.html">About</Link>
            </div>
            <div>
             <Link className="font-sans " to="contact.html">Contact</Link>
            </div>
        ...
        <div className="col-span-1 md:col-span-1 flex flex-col">
          ...
          <Link className="font-sans" to="contact" target="_blank">Malviya Nagar,Jaipur</Link>
        ...
        <div className="col-span-1 md:col-span-2 lg:col-span-1">
          ...
          <div className="mt-4">
            <Link to="donate.html" className="font-sans bg-slate-400 text-white px-6 py-2 bg-gradient-to-r from-zinc-700 to-gray-900 hover:from-zinc-900 hover:to-stone-900 ">Join Us Today</Link>
          </div>
        </div>
      </div>
